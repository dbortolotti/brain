...
Updated: `2026-05-07 20:47:17 BST`
Expected end: `2026-05-07 20:47:18 BST (0 min remaining at 1060892.2 tests/min)`
...
| `groq:llama-3.3-70b-versatile` | `atomic_card_extractor` | pending | 0 / 135 | 0 | 0 | 0 |
...
| `groq:llama-3.3-70b-versatile` | `conflict_candidate_detector` | pending | 0 / 99 | 0 | 0 | 0 |
...
| `groq:llama-3.3-70b-versatile` | `debug_explainer` | pending | 0 / 72 | 0 | 0 | 0 |
