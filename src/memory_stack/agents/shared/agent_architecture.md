# Brain Memory Agent Architecture — Coding Agent Implementation Instructions

## 0. Mission

Implement dedicated agent interfaces for the Brain memory system.

These Brain memory agents are designed for:
...
Brain memory agents should **not** be general assistants. They are narrow, specialised interfaces for adding, retrieving, inspecting, and correcting memories in Brain.
