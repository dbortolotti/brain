...
BRAIN_SLACK_SIGNING_SECRET=replace-me
BRAIN_SLACK_BOT_TOKEN=replace-me
...
ensure_env_var "BRAIN_SLACK_SIGNING_SECRET" "replace-me"
ensure_env_var "BRAIN_SLACK_BOT_TOKEN" "replace-me"
