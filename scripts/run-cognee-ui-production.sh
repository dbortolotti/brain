...
export BRAIN_UI_PROXY_PORT="${BRAIN_UI_PROXY_PORT:-8002}"
export BRAIN_UI_FRONTEND_PORT="${BRAIN_UI_FRONTEND_PORT:-3000}"
export BRAIN_UI_BACKEND_PORT="${BRAIN_UI_BACKEND_PORT:-8001}"
export BRAIN_PUBLIC_UI_PATH="${BRAIN_PUBLIC_UI_PATH:-/ui}"
export BRAIN_PUBLIC_UI_API_PATH="${BRAIN_PUBLIC_UI_API_PATH:-/ui-api}"
