...
FINE_BRIEFS = {
    ...
    "entity_final_resolver": "Apply final deterministic entity resolution policy after candidate ranking.",
    ...
    "conflict_policy_decider": "Apply final conflict policy after model-assisted detection and explanation.",
